...
function App() {
  ...
  const notify = () => toast.success('The email has been successfully sent. Thank you for contacting me, I will reply to you as soon as possible with best regards.', {
    position: "top-right",
    autoClose: 3000,
  ...
  const onSubmit: any = async (data: { email: string; name: any; phone: any; message: any; }) => { // Use SubmitHandler
    ...
    try {
      ...
      console.error('Error:', err);
      setError("general", { type: "manual", message: "An error occurred while sending the email." });
    }
  };
                  ...
                  <div className="flex-col justify-start lg:items-start items-center gap-4 flex">
                    ...
                    <div className="w-full flex flex-col justify-start lg:items-start items-center gap-3 ">
                      ...
                      <p className="text-gray-500 text-base font-normal leading-relaxed lg:text-start text-center">
                        Innovative software developer who loves learning new technologies & mastering software engineering. I am committed to utilizing my skills to further the company's mission. I believe that success only comes from working hand in hand with my team & I believe in solving community issues through technology.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="w-full justify-start items-center gap-8 grid md:grid-cols-2 grid-cols-1">
                      <div
                        ...
                        <p className="text-gray-500 text-base font-normal leading-relaxed">
                          Creating state-of-the-art solutions for society through technology & coding.
                        </p>
                      </div>
                      <div
                        className="w-full h-full p-3.5 rounded-xl border border-gray-200 hover:border-gray-400 transition-all duration-700 ease-in-out flex-col justify-start items-start gap-2.5 inline-flex">
                  ...
                  <div className="flex w-full overflow-auto flex-col justify-start items-start flex-wrap h-full max-h-[800px] gap-y-2 gap-x-3">
                    {Object.values(skillsData.reduce((acc: any, skill: any) => {
                      ...
                      <div key={group.groupName} className="flex flex-col w-full max-w-52 pb-2">
                        <div className="flex-col justify-start lg:items-start items-center flex gap-1">
                          <h1 className="font-manrope text-sm leading-10 relative left-0">{group.groupName}</h1>
              ...
              <div className="w-full flex-col justify-center lg:items-start items-center gap-10 inline-flex">
                <div className="w-full flex-col justify-center items-start gap-8 flex">
                  ...
                  <div className='flex lg:flex-row w-full flex-col'>
                    <div className="education px-4 md:px-5 lg:px-5 mx-auto h-full w-full max-w-[400px]">
                          ...
                          <div className="items-center justify-between p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:flex dark:bg-gray-700 dark:border-gray-600">
                            <div className=" text-sm font-normal text-gray-500 dark:text-gray-300">
                              <span className="p-4 flex flex-col bg-gray-100 text-gray-800 text-xs font-normal me-2 px-2.5 py-0.5 rounded dark:bg-gray-600 dark:text-gray-300">
                                I'm interested in the latest technology & self-development. I love swimming & sports. I love listening; I'm a fairly good
                                listener. I love learning & I love the excitement of learning, especially in the field of programming. I love camping trips & cruises.
                              </span>
                            </div>
                          </div>
                        </li>
                            ...
                            <div className="p-3 text-xs italic font-normal text-gray-500 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-600 dark:border-gray-500 dark:text-gray-300">
                              <ul className="flex flex-col pl-3 gap-y-1 list-disc">
                                ...
                                <li>AI Integration: Leveraged Artificial Intelligence to assist writers with formatting, translation, text summarization, and
                                  content enhancement, significantly improving the efficiency & quality of content creation.</li>
                                <li>Collaboration with NewsHQ & AssetHQ: Worked with NewsHQ & AssetHQ to integrate additional features, improving
                                  overall system capabilities & user experience.</li>
                                <li>Microservices Architecture: Adopted a microservices architecture to divide the project into smaller, manageable services,
                                  facilitating easier development, maintenance, & scalability.</li>
                        ...
                        <li className="mb-5 ms-6">
                          ...
                          <div className="p-4 bg-white border  border-gray-200 rounded-lg shadow-sm dark:bg-gray-700 dark:border-gray-600">
                            ...
                            <div className="p-3 text-xs italic font-normal text-gray-500 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-600 dark:border-gray-500 dark:text-gray-300">
                              <ul className="flex flex-col pl-3 gap-y-1 list-disc">
                                <li>
                                  Developed a Telegram bot using Node.js to track project progress, manage invoices, & handle permissions, enhancing project
                                ...
                                <li>
                                  ...
                                  handles semesters, curriculum, trainers, trainees, exam schedules, & more, including notifications.
                                </li>
                                <li>
                                  Developed the Saha Yönetim Sistemi (Field Management System) for Baykar, an ERP system for managing company
                                  resources, branches, field resources, employee tracking, priority organization, & fair employee evaluation.
                                </li>
                                <li>
                        ...
                        <li className="mb-10 ms-6">
                          ...
                          <div className="p-4 bg-white border  border-gray-200 rounded-lg shadow-sm dark:bg-gray-700 dark:border-gray-600">
                            ...
                            <div className="p-3 text-xs italic font-normal text-gray-500 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-600 dark:border-gray-500 dark:text-gray-300">
                              <ul className="flex flex-col pl-3 gap-y-1 list-disc">
                                <li>
                                  Ustaol specializes in connecting culinary ingredients with easy-to-follow recipes. We relied on .NET Core to build the backend to ensure performance & stability, & used Razor & Blazor to deliver an interactive user interface that simplifies the cooking experience for users & ensures smooth navigation.
                                </li>
                                <li>
                                ...
                                <li>
                                  Built an e-shopping app with Visual Studio & .NET Core Blazor, integrating ERP functionality to provide a mobile-friendly
                                  platform, boosting sales by 20%.
                                </li>
                                <li>
                                  Optimized finance resource utilization using "Ubuntu Remmina" & Raspberry Pi, enabling simultaneous access to a central
                      ...
                      <div className="absolute bottom-0 w-full lg:p-11 p-5">
                        <div className="bg-white rounded-lg p-6 block">
                          <a href="javascript:;" className="flex items-center mb-6">
                            <span className="icon-[healthicons--phone-outline] w-9 h-9" style={{ 'color': '#4F46E5' }}></span>
                            <h5 className="text-black text-base font-normal leading-6 ml-5">+90 539 671 13 55</h5>
                          </a>
                          <a href="javascript:;" className="flex items-center mb-6">
                            <span className="icon-[proicons--mail] w-9 h-9" style={{ 'color': '#4F46E5' }}></span>
                            <h5 className="text-black text-base font-normal leading-6 ml-5">omar.omar.alkadri111@gmail.com</h5>
                          </a>
                          <a href="javascript:;" role="button" className="flex items-center" aria-label="Address location">
                            <span className="icon-[ph--map-pin] w-9 h-9" style={{ 'color': '#4F46E5' }}></span>
                            <h5 className="text-black text-base font-normal leading-6 ml-5">
                              Aksu Street, Building No. 6, Apartment 89, Kecioren, Ankara, Turkey
                            </h5>
                          </a>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="bg-gray-50 p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl">
                  ...
                  <div className="mb-4">
                    <input
                      ...
                      type="text"
                      className={`w-full h-12 text-gray-600 placeholder-gray-400 shadow-sm bg-transparent text-lg font-normal leading-7 rounded-full border ${errors.name ? 'border-red-500' : 'border-gray-200'} focus:outline-none pl-4`}
                      placeholder="Name"
                    />
                  ...
                  <div className="mb-4">
                    <input
                      ...
                      type="text"
                      className={`w-full h-12 text-gray-600 placeholder-gray-400 shadow-sm bg-transparent text-lg font-normal leading-7 rounded-full border ${errors.email ? 'border-red-500' : 'border-gray-200'} focus:outline-none pl-4`}
                      placeholder="Email"
                    />
                  ...
                  <div className="mb-4">
                    <input
                      ...
                      type="text"
                      className={`w-full h-12 text-gray-600 placeholder-gray-400 shadow-sm bg-transparent text-lg font-normal leading-7 rounded-full border ${errors.phone ? 'border-red-500' : 'border-gray-200'} focus:outline-none pl-4`}
                      placeholder="Phone"
                    />
                    {errors.phone && <p className="text-red-500 text-sm mt-1">{errors.phone.message as React.ReactNode}</p>}
                  </div>
                  <div className="mb-4">
                    <textarea
                      {...register("message", { required: "Message is required." })}
                      rows={4}
                      className={`w-full h-32 p-2.5 text-gray-600 placeholder-gray-400 bg-transparent text-lg shadow-sm font-normal leading-7 rounded-xl border ${errors.message ? 'border-red-500' : 'border-gray-200'} focus:outline-none pl-4`}
                      placeholder="Write your thoughts here..."
                    ></textarea>
                    {errors.message && <p className="text-red-500 text-sm mt-1">{errors.message.message as React.ReactNode}</p>}
                  </div>
